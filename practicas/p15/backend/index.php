<?php
    ...
    $app->get('/list', function($request, $response, $args){
        ...
        $products = new Read("root", "mendoza21:)", "marketzone");
    ...
    $app->post('/add', function($request, $response, $args){
        ...
        $products = new Create("root", "mendoza21:)", "marketzone");
    ...
    $app->post('/edit', function($request, $response, $args){
        ...
        $products = new Update("root", "mendoza21:)", "marketzone");
    ...
    $app->post('/delete', function($request, $response, $args){
        ...
        $products = new Delete("root", "mendoza21:)", "marketzone");
