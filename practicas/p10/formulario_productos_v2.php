...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <fieldset>
            ...
            <li><label for="form-nombre">Nombre del producto:</label> <input type="text" name="nombre_producto" id="form-nombre" value="<?= $_GET['nombre'] ?>" required></li>
                <li>
                ...
                <li><label for="form-modelo">Modelo del producto:</label> <input type="text" name="modelo_producto" id="form-modelo" value="<?= $_GET['modelo'] ?>" required></li>
                <li><label for="form-precio">Precio del producto: </label><input type="number" name="precio_producto" value="<?= $_GET['precio'] ?>" placeholder="1.0" step="1" min="0" max="1000" required/></li>
                <li><label for="form-detalles">Detalles:</label><br><input type="text" name="detalles_producto" id="form-detalles" value="<?= $_GET['detalles'] ?>"></li>
                <li><label for="form-unidades">Unidades a registrar:</label><input type="number" id="form-unidades" value="<?= $_GET['unidades'] ?>" name="unidades_producto" min="1" max="1000" required/></li>
